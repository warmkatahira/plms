...
class EmployeeCreateRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'daily_working_hours'                           => ['required','numeric','min:0','max:10',Rule::in(array_keys(WorkingHoursEnum::DAILY_WORKING_HOURS)),],
            'half_day_working_hours'                        => ['required','numeric','min:0','max:10',Rule::in(array_keys(WorkingHoursEnum::HALF_DAY_WORKING_HOURS)),],
