...
class StatutoryLeaveUpdateService
{
    ...
    public function setArrayImportData($save_file_path, $headers, $import_original_file_name)
    {
        ...
        if(count(array_filter($validation_error)) != 0){
            ...
            throw new FileImportException("データが正しくないため、取り込みできませんでした。", ImportEnum::IMPORT_PROCESS_STATUTORY_LEAVE, ImportEnum::IMPORT_TYPE_UPDATE, $error_file_name, $import_original_file_name);
        }
