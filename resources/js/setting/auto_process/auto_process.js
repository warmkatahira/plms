...
$('#action_type').on('change', function () {
    ...
    const config = {
        ...
        order_item_create: {
            ...
            enable: ['#action_value_order_item_id', '#action_value_order_quantity']
        },
        default: {
    ...
    $('#action_value_text_wrapper, #action_value_delivery_company_wrapper, #action_value_order_item_create_wrapper, #action_value_desired_delivery_time_wrapper, #action_value_shipping_base_id_wrapper')
        .hide();
    $('#action_value_text, #action_value_delivery_company, #action_value_order_item_id, #action_value_order_quantity, #action_value_desired_delivery_time, #action_value_shipping_base_id')
        .prop('disabled', true);
    // 選択された設定を適用
