<form method="POST"
    ...
    <div class="flex flex-col border border-gray-400 divide-y divide-gray-400">
        ...
        <x-form.input type="tel" label="1日あたりの時間数" id="daily_working_hours" name="daily_working_hours" :value="$form_mode === 'update' ? $employee->paid_leave->daily_working_hours : null" required="true" />
        <x-form.input type="tel" label="半日あたりの時間数" id="half_day_working_hours" name="half_day_working_hours" :value="$form_mode === 'update' ? $employee->paid_leave->half_day_working_hours : null" required="true" />
