<form method="GET" action="{{ route($route) }}" id="search_form">
    ...
    <div class="flex flex-col gap-y-2 p-3 bg-white min-w-60 text-xs border border-black">
        <x-search.input type="text" label="セット商品コード" id="search_set_item_code" name="search_set_item_code" />
        <x-search.input type="text" label="セット商品名" id="search_set_item_name" name="search_set_item_name" />
