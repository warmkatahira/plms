    ...
    <div class="flex flex-row gap-5">
        <div class="w-1/2">
            <div class="flex flex-col">
                ...
                <x-order.order-detail.info-div label="送料" :value="number_format($order->shipping_fee)" />
                <x-order.order-detail.info-div label="支払金額" :value="number_format($order->payment_amount)" />
            </div>
        </div>
        <div class="w-1/2">
            <div class="flex flex-col">
                ...
                <x-order.order-detail.info-div label="配送希望時間" :value="$order->desired_delivery_time_jp" />
