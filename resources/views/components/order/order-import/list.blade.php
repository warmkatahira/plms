        ...
        <table class="text-xs">
            <thead>
                <tr class="text-left text-white bg-black whitespace-nowrap sticky top-0">
                    ...
                    <th class="font-thin py-1 px-2 text-center">取込タイプ</th>
                    <th class="font-thin py-1 px-2 text-center">取込ファイル名</th>
                    <th class="font-thin py-1 px-2 text-center">取得件数</th>
            ...
            <tbody class="bg-white">
                @foreach($orderImportHistories as $order_import_history)
                    <tr class="text-left cursor-default whitespace-nowrap hover:bg-theme-sub group">
                        ...
                        <td class="py-1 px-2 border text-center">{{ $order_import_history->import_type }}</td>
                        ...
                        <td class="py-1 px-2 border">
                            ...
                            <a href="{{ route('error_file_download.download', ['filename' => $order_import_history->error_file_name]) }}" class="text-center text-blue-500"><i class="las la-cloud-download-alt mr-1 la-lg"></i>ダウンロード</a>
                        @endif
                        </td>
