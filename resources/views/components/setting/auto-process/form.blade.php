<form method="POST"
    ...
    <div class="flex flex-col border border-gray-400 divide-y divide-gray-400">
        ...
        <div id="action_value_order_item_create_wrapper" class="flex flex-col divide-y divide-gray-400">
            ...
            <x-form.input type="tel" label="注文数" id="action_value_order_quantity" name="order_quantity" :value="$form_mode === 'update' ? $auto_process->auto_process_order_item?->order_quantity : null" required="true" />
        </div>
