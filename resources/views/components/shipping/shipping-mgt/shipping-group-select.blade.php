        ...
        @foreach($shippingMethods as $shipping_method)
            <div class="flex mt-5 border-b border-gray-600 pb-2">
                ...
                <div class="flex flex-row">
                    ...
                    <a href="{{ route('nifuda_create.create_by_shipping_method', ['shipping_method_id' => $shipping_method->shipping_method_id]) }}" class="nifuda_issue text-sm text-blue-500"><i class="las la-file mr-1 la-lg"></i>荷札データ作成</a>
                </div>
            </div>
        @endforeach
    @endif
