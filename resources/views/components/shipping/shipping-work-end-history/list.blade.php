        ...
        <table class="text-xs">
            <thead>
                <tr class="text-left text-white bg-black whitespace-nowrap sticky top-0">
                    <th class="font-thin py-1 px-2">出荷完了日時</th>
                    ...
                    <tr class="text-left hover:bg-theme-sub cursor-default whitespace-nowrap @if(!$shipping_work_end_history->is_successful) bg-pink-200 @endif">
                        ...
                        <td class="py-1 px-2 border">
                            @if(!is_null($shipping_work_end_history->error_file_name))
                                <a href="{{ route('error_file_download.download', ['filename' => $shipping_work_end_history->error_file_name]) }}" class="text-center text-blue-500"><i class="las la-cloud-download-alt mr-1 la-lg"></i>ダウンロード</a>
                            @endif
                        </td>
