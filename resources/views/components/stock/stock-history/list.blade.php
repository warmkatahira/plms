                ...
                @foreach($stockHistories as $stock_history)
                    <tr class="text-left cursor-default whitespace-nowrap hover:bg-theme-sub group">
                        <td class="py-1 px-2 border">
                            <img class="item_image mx-auto" src="{{ asset('storage/item_images/'.$stock_history->item_image_file_name) }}">
                        </td>
                        ...
                        <td class="py-1 px-2 border">{{ $stock_history->item_category_2 }}</td>
