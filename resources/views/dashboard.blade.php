    ...
    @if(Auth::user()->role_id === RoleEnum::USER)
        <div class="grid grid-cols-12 gap-3">
            ...
            <div class="col-span-12 grid grid-cols-12 gap-3">
                <x-dashboard.info-div label="保有日数" :value="$employee->paid_leave->paid_leave_granted_days" format="day" />
                <x-dashboard.info-div label="取得日数" :value="$employee->paid_leave->paid_leave_used_days" format="day" usedDays="true"  />
                <x-dashboard.info-div label="残日数" :value="$employee->paid_leave->paid_leave_remaining_days" format="day" />
            </diiv>
            <div class="col-span-12 grid grid-cols-12 gap-3">
