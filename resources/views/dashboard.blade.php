<x-app-layout>
    <div class="grid grid-cols-12 gap-3">
        ...
        <div class="col-span-12 grid grid-cols-12 gap-3">
            <x-dashboard.info-div label="義務日数" :value="$employee->statutory_leave->statutory_leave_days" formatType="day" />
            <x-dashboard.info-div label="義務残日数" :value="$employee->statutory_leave->statutory_leave_remaining_days" formatType="day" />
