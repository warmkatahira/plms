<div id="navigation-bar">
    ...
    <div class="flex flex-col gap-3 pt-7 pl-5">
        ...
        <div class="flex flex-col gap-0.5">
            <x-navigation-btn label="出荷" icon="las la-truck" openCloseKey="shipping" />
             <div class="navigation-content hidden">
                ...
                <x-navigation-btn route="abc_analysis.index" label="ABC分析" isLeftMargin="true" isRightMargin="true" />
            </div>
        </div>
        <!-- 商品 -->
        <div class="flex flex-col gap-0.5">
            <x-navigation-btn label="商品" icon="las la-tshirt" openCloseKey="item" />
             <div class="navigation-content hidden">
                ...
                <x-navigation-btn route="set_item.index" label="セット商品" isLeftMargin="true" isRightMargin="true" />
                <x-navigation-btn route="item_mall_mapping.index_item" label="モール商品マッピング" isLeftMargin="true" isRightMargin="true" />
        ...
        <div class="flex flex-col gap-0.5">
            ...
            <div class="navigation-content hidden">
                <x-navigation-btn route="order_import_pattern.index" label="受注取込パターン" isLeftMargin="true" isRightMargin="true" />
        ...
        @can('admin_check')
            <!-- システム管理 -->
             <div class="flex flex-col gap-0.5">
                ...
                <div class="navigation-content hidden">
                    <x-navigation-btn route="company.index" label="会社" isLeftMargin="true" isRightMargin="true" />
                    <x-navigation-btn route="base.index" label="倉庫" isLeftMargin="true" isRightMargin="true" />
                    <x-navigation-btn route="mall.index" label="モール" isLeftMargin="true" isRightMargin="true" />
                    ...
                    <x-navigation-btn route="makeshop_sample.index" label="API" isLeftMargin="true" isRightMargin="true" />
                </div>
            </div>
        @endcan
    </div>
