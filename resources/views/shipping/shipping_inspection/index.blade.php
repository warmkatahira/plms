        ...
        <div class="flex flex-col">
            <form method="POST" action="{{ route('shipping_inspection.complete') }}" class="m-0" id="shipping_inspection_form">
                ...
                <div class="flex flex-row mb-2">
                    ...
                    <input type="tel" id="order_control_id" name="order_control_id" autocomplete="off">
                </div>
                <div class="flex flex-row mb-2">
                    <p class="pt-2.5 w-40 bg-black text-white pl-2">配送伝票番号</p>
                    <input type="tel" id="tracking_no" name="tracking_no" autocomplete="off">
                </div>
                <div class="flex flex-row mb-2">
                    <p class="pt-2.5 w-40 bg-black text-white pl-2">商品識別コード</p>
                    <input type="tel" id="item_id_code" name="item_id_code" autocomplete="off">
                </div>
            </form>
        </div>
        <!-- メッセージ -->
