                ...
                <table id="receiving_complete_table" class="text-sm w-full">
                    <thead>
                        <tr class="text-xs text-left text-white bg-black whitespace-nowrap sticky top-0">
                            <th class="font-thin py-1 px-2 text-center w-1/12">操作</th>
                            <th class="font-thin py-1 px-2 text-center w-2/12">商品コード</th>
                            <th class="font-thin py-1 px-2 text-center w-2/12">商品JANコード</th>
                            <th class="font-thin py-1 px-2 text-center w-6/12">商品名</th>
                            <th class="font-thin py-1 px-2 text-center w-1/12">数量</th>
                        </tr>
                    </thead>
...
@vite(['resources/js/stock/receiving_inspection/receiving_inspection.js'])